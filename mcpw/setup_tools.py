...
def create_main_lines():
    ...
    main_lines.append(f'')
    main_lines.append(f'def custom_function3(var,mcvar,msg):')
    ...
    main_lines.append(f'##########################################################')
    main_lines.append(f'')
    main_lines.append(f'# adding functions to pre mcstas function group')
    main_lines.append(f'def pre_simulation(var,mcvar,msg):')
    main_lines.append(f'    custom_function1(var,mcvar,msg)')
    main_lines.append(f'')
    main_lines.append(f'# adding functions to post mcstas function group')
    main_lines.append(f'def post_simulation(var,mcvar,msg):')
    ...
    main_lines.append(f'    custom_function3(var,mcvar,msg)')
    main_lines.append(f'')
